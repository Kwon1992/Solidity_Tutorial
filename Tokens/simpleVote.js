let contractAddress = '0x6aD780a8eb0C34e54C1B18B329A0Ec85EAB6Ca76';
let abi = 
 [
  {
    "constant": true,
...
window.addEventListener('load', function() {
  ...
  if (typeof web3 !== 'undefined') {
    ...
    window.web3 = new Web3(new Web3.providers.HttpProvider("http://166.104.144.105:8500"));
	}
...
function getLink(addr) {
  return '<a target="_blank" href=https://ropsten.etherscan.io/tx/' + addr + '>' + addr +'</a>';
}
...
function voteForCandidate(param) {
  //let candidateName = $("#candidate").val();
	...
	{
		case 1 :
			candidateName = "Monday";
			break; 
		case 2 :
			candidateName = "Tuesday";
			break;
		case 3 :
			candidateName = "Wednesday";
			break;
		case 4 :
			candidateName = "Thursday";
			break;
		case 5 :
			candidateName = "Friday";
			break;
		case 6 :
			candidateName = "Saturday";
			break;
		case 7 :
			candidateName = "Sunday";
			break;
	}

  $("#msg").html("Vote has been submitted. The vote count will increment as soon as the vote is recorded on the blockchain. Please wait.")

	simpleVote.adopt(param,{from: web3.eth.accounts[0]},function(e,r){
